...
public class AuthController {
    ...
    public ResponseEntity login(@RequestBody LoginRequestDTO body){
        ...
        if(passwordEncoder.matches(body.senha(), professorModel.getSenha())) {
            ...
            return ResponseEntity.ok(new ResponseDTO(professorModel.getId(), professorModel.getNome(), token));
        }
    ...
    public ResponseEntity register(@RequestBody RegisterRequestDTO body){
        ...
        if(professorModel.isEmpty()) {
            ...
            return ResponseEntity.ok(new ResponseDTO(newProfessorModel.getId(), newProfessorModel.getNome(), token));
        }
        return ResponseEntity.badRequest().build();
    }
}
