...
public class AuthController {
    ...
    public ResponseEntity<ResponseDTO> login(@RequestBody LoginRequestDTO body){
        ...
        if (senha == null || senha.isBlank() || body.getEmail() == null || body.getEmail().isBlank()) {
            return ResponseEntity.badRequest().build();
        }

        ProfessorModel professorModel = this.repository.findOptionalByEmail(body.getEmail())
    ...
    public ResponseEntity<ResponseDTO> register(@RequestBody RegisterRequestDTO body){
        ...
        String senha = body.getSenha();
        if (nome == null || nome.isBlank() || senha == null || senha.isBlank() || body.getEmail() == null || body.getEmail().isBlank()) {
            return ResponseEntity.badRequest().build();
        }

        Optional<ProfessorModel> professorModel = this.repository.findOptionalByEmail(body.getEmail());
        ...
        if(professorModel.isEmpty()) {
            ...
            newProfessorModel.setEmail(body.getEmail());
